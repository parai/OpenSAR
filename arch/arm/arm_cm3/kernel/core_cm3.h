...
__INLINE void __enable_irq()               { __ASM volatile ("cpsie i"); }
__INLINE void __disable_irq()              { __ASM volatile ("cpsid i"); }

__INLINE void __enable_fault_irq()         { __ASM volatile ("cpsie f"); }
__INLINE void __disable_fault_irq()        { __ASM volatile ("cpsid f"); }

__INLINE void __NOP()                      { __ASM volatile ("nop"); }
__INLINE void __WFI()                      { __ASM volatile ("wfi"); }
...
__INLINE void __CLREX()                    { __ASM volatile ("clrex"); }
