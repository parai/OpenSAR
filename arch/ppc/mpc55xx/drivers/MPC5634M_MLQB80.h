...
//#include "ip_edma.h"
    ...
    struct EDMA_tag {
        ...
        } ES;                  /* <URM>DMAES</URM> Error Status Register */
        ...
        } SERQ;                /* <URM>DMASERQ</URM> , DMA Set Enable Request Register */

        union {
            vuint8_t R;
            vuint8_t B;         /* <URM>NOP:1 CERQ:7</URM> */
        } CERQ;                /* <URM>DMACERQ</URM> , DMA Clear Enable Request Register */
        ...
        } CINT;                /* <URM>DMACINT</URM> , DMA Clear Interrupt Request Register */
...
/****************************************************************************/
    ...
    struct EDMA_TCD_CHLINK_tag {  /*for alternate format TCDs (when EDMA.TCD[x].CITER.E_LINK==BITER.E_LINK=1 ) */
...
/****************************************************************************/
    ...
    struct SWT_tag {
        ...
        } CR;                  /*<URM>SWT_CR</URM> *//* Module Configuration Register */
