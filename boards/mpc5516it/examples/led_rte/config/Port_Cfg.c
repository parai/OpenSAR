...
const uint16_t PortPadConfigData[] = {
	...
	( PORT_FUNC0 | PORT_OBE_ENABLE | PORT_SLEW_RATE_MIN | PORT_PULL_NONE ),	/* PCR	52 : PORT_PIN_MODE_DIO */
	( PORT_FUNC0 | PORT_OBE_ENABLE | PORT_SLEW_RATE_MIN | PORT_PULL_NONE ),	/* PCR	53 : PORT_PIN_MODE_DIO */
