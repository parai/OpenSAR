...
//  PduR Polite Defines.
#define PDUR_PDU_ID_ENG_TX		0
#define PDUR_REVERSE_PDU_ID_ENG_TX		0
#define PDUR_PDU_ID_LAMPS_RX		1
#define PDUR_REVERSE_PDU_ID_LAMPS_RX		1
#define PDUR_PDU_ID_TCM_RX		2
#define PDUR_REVERSE_PDU_ID_TCM_RX		2
