...
// See section 9.4.3 DMA Request Assignments in MPC5567 RM
typedef enum
{
  ...
  DMA_SPI_D_TRANSMIT_CHANNEL,
  DMA_SPI_D_RECEIVE_CHANNEL,

  DMA_SPI_COMBINED_TRANSMIT_CHANNEL,
  DMA_SPI_COMBINED_RECEIVE_CHANNEL,
