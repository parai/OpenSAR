...
// Alarm Id's
#define ALARM_ID_BlinkerAlarm	0
#define ALARM_ID_MainFunctionAlarm	1
#define ALARM_ID_StepAlarm	2
...
#define TASK_ID_MainFunctionTask	2
#define TASK_ID_StartupTask	3
#define TASK_ID_StepTask	4
