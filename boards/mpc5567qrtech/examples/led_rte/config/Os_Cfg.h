...
// Counter macros
#define OSMAXALLOWEDVALUE_OsTick		OSMAXALLOWEDVALUE
#define OSTICKSPERBASE_OsTick			1 // NOT CONFIGURABLE IN TOOLS
#define OSMINCYCLE_OsTick				1
#define OS_TICKS2SEC_OsTick(_ticks)		( (OSTICKDURATION * _ticks)/1000000000UL )
#define OS_TICKS2MS_OsTick(_ticks)		( (OSTICKDURATION * _ticks)/1000000UL )
#define OS_TICKS2US_OsTick(_ticks)		( (OSTICKDURATION * _ticks)/1000UL )
#define OS_TICKS2NS_OsTick(_ticks)		(OSTICKDURATION * _ticks)



// Event masks
#define EVENT_MASK_ScheduleEvent	1
...
#define TASK_ID_Scheduled	1
#define TASK_ID_Startup	2
