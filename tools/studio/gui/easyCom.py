...
class easyComGui(QMainWindow):
    ...
    def creMenu(self):
        ...
        self.qAction4=QAction(self.tr('Note:P2P and P2A config is not ready now!'),self)  
        self.qAction4.setStatusTip("""
Note:P2P and P2A config is not ready now!
P2P and P2A action is all the same,
so hand work based on the code generated by easyCom is needed.
        """)
        self.menuBar().addAction(self.qAction4)
        self.qAction4.setDisabled(False)
